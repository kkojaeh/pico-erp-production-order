...
@ToString
public class ProductionOrderId implements Serializable {
  ...
  @JsonCreator
  public static ProductionOrderId from(@NonNull String value) {
    try {
  ...
  public static ProductionOrderId from(@NonNull UUID value) {
